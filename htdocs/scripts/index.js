...
/***/ function(module, exports, __webpack_require__) {
	...
	var _module = __webpack_require__(55);
	...
	window.addEventListener('DOMContentLoaded', function () {
	  ...
	  modules_.forEach(function (_arr) {
	    createIncetance.apply(undefined, (0, _toConsumableArray3.default)(_arr));
	  });
	
	  singleModules_.forEach(function (_arr) {
	    createSingleIncetance.apply(undefined, (0, _toConsumableArray3.default)(_arr));
	  });
	});
