...
(function($){
	...
	$.extend( $.flickSimple.prototype, {
		...
		touchmove: function(e) {
			...
			// (START) ADD: over swipeing stop touchmove
			if ( o.horizontal ) {
				if ( 0 < o.currentX + ( nowX - o.startX ) ) {
					o.nextY = 0;
				}
				else if ( -o.elmWidth > o.currentX + ( nowX - o.startX ) ) {
					o.nextY = -o.elmWidth;
				}
			}
			else if ( o.vertical ) {
				if ( 0 < o.currentY + ( nowY - o.startY ) ) {
					o.nextY = 0;
				}
				else if ( -o.elmHeight > o.currentY + ( nowY - o.startY ) ) {
					o.nextY = -o.elmHeight;
				}
			}
			// (END) ADD: over swipeing stop touchmove
			if ( ! o.useCSSAnim ) {
